...
<div className="absolute top-1 right-1">
  <i class={`fas fa-heart text-gray-600 text-xl hover:text-red-500 ${saved?'text-red-600':'text-gray-500'} `} onClick={() => {
        setSaved(!saved);
        alert(saved ? "Removed from favourites" : " Saved to favourites");
      }} ></i>
</div>
              </div>
             ...
             <div className="flex gap-2">
                ...
                <button className="border-1 rounded-sm border-green-700 p-1 w-30">Message Doctor</button>
             </div>
              </div>
            </div>
