...
function Howitworks() {
  return (
    <div className="works-div bg-gray-950 w-full pb-16 mb-12 mt-20 text-white">
      ...
      <div className="how-it-works flex justify-center gap-10 px-6">

        {/* Step 1 */}
        <div className="works-div-inner bg-gray-900 p-6 rounded-xl w-60 text-center shadow-md hover:scale-105 transition">
